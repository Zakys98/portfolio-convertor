...
from convertor.utils import parse_float
...
class Trading212Stock(Stock):
    ...
    def from_dict(cls, data: dict[str, str]) -> Self:
        return cls(
            ...
            name=data.get("Name", ""),
            time=data.get("Time", ""),
            quantity=parse_float(data.get("No. of shares")),
            share_price=parse_float(data.get("Price / share")),
            ...
            total_price=parse_float(data.get("Total")),
        )
